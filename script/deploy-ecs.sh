...
usage="Usage: deploy-ecs.sh [tindawg-app-web|tindawg-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/tindawg:$2"
...
aws ecs update-service --cluster tindawg \
  --no-cli-pager \
  --region "$ecs_region" \
