...
# Lambda URIs are "{+lambda}/{+function}" e.g. "tindawg/ping".
# We also support path matching at the root e.g. "tindawg" but these require definining separate "_root" terraform resources.
